...
{
	if (region.aT.ak === region.a3.ak)
	{
		return 'on line ' + region.aT.ak;
	}
	return 'on lines ' + region.aT.ak + ' through ' + region.a3.ak;
}
...
var _Http_toTask = F3(function(router, toTask, request)
{
	return _Scheduler_binding(function(callback)
	{
		...
		try {
			xhr.open(request.cN, request.dD, true);
		} catch (e) {
			return done($elm$http$Http$BadUrl_(request.dD));
		}
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {a6: fragment, bb: host, bo: path, bq: port_, bt: protocol, bu: query};
	});
...
var $author$project$Header$Connexion = 0;
var $author$project$Footer$ForLanding = 1;
var $author$project$Page$PageType$Landing = {$: 1};
var $author$project$User$NotSet = {$: 0};
...
var $author$project$Main$init = function (_v0) {
	var initialModel = {
		O: 1,
		ax: 0,
		j: $author$project$Page$PageType$Landing,
		J: {cY: '', dE: ''},
		p: {ce: '', cs: '', cK: '', cM: ''},
		W: $author$project$User$NotSet
	};
...
var $author$project$User$Failure = {$: 1};
var $author$project$Footer$ForImages = 5;
var $author$project$Footer$ForTutos = 4;
var $author$project$Page$PageType$Home = {$: 2};
var $author$project$Header$Identified = 1;
var $author$project$Page$PageType$Images = {$: 6};
var $author$project$Footer$Nav = 3;
var $author$project$Page$Announce$New = 0;
var $author$project$User$Set = function (a) {
	return {$: 2, a: a};
};
var $author$project$Page$PageType$SignIn = {$: 4};
var $author$project$Page$PageType$Subscribe = {$: 3};
var $author$project$Page$PageType$Tutos = {$: 5};
var $author$project$Page$Announce$WhatDoWeDo = 2;
var $author$project$Page$Announce$WhatIsIt = 1;
var $author$project$Page$Announce$WhenDoWeStart = 3;
var $author$project$Message$GotUserProfile = function (a) {
	return {$: 12, a: a};
};
var $author$project$User$UserInfos = F2(
	function (id, username) {
		return {cz: id, dE: username};
	});
var $elm$json$Json$Decode$field = _Json_decodeField;
var $elm$json$Json$Decode$string = _Json_decodeString;
var $author$project$Request$decodeUserProfile = A3(
	$elm$json$Json$Decode$map2,
	$author$project$User$UserInfos,
	A2(
...
var $author$project$Request$encodeUserCredentials = function (form) {
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'username',
				$elm$json$Json$Encode$string(form.dE)),
				_Utils_Tuple2(
				'password',
				$elm$json$Json$Encode$string(form.cY))
			]));
};
...
var $elm$http$Http$request = function (r) {
	return $elm$http$Http$command(
		$elm$http$Http$Request(
			{bY: false, b4: r.b4, cp: r.cp, a8: r.a8, cN: r.cN, dy: r.dy, bG: r.bG, dD: r.dD}));
};
var $elm$http$Http$post = function (r) {
	return $elm$http$Http$request(
		{b4: r.b4, cp: r.cp, a8: _List_Nil, cN: 'POST', dy: $elm$core$Maybe$Nothing, bG: $elm$core$Maybe$Nothing, dD: r.dD});
};
var $author$project$Request$authenticateUser = function (form) {
	return $elm$http$Http$post(
		{
			b4: $elm$http$Http$jsonBody(
				$author$project$Request$encodeUserCredentials(form)),
			cp: A2($elm$http$Http$expectJson, $author$project$Message$GotUserProfile, $author$project$Request$decodeUserProfile),
			dD: 'https://rare-lined-hagfish.gigalixirapp.com/api/users/sign_in'
		});
};
		...
		switch (msg.$) {
			case 9:
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{O: 3, j: $author$project$Page$PageType$Home}),
			...
			case 0:
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							j: $author$project$Page$PageType$Announcement(0)
						}),
					$elm$core$Platform$Cmd$none);
			case 1:
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							j: $author$project$Page$PageType$Announcement(1)
						}),
					$elm$core$Platform$Cmd$none);
			case 2:
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							j: $author$project$Page$PageType$Announcement(3)
						}),
					$elm$core$Platform$Cmd$none);
			case 3:
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							j: $author$project$Page$PageType$Announcement(2)
						}),
					$elm$core$Platform$Cmd$none);
			case 4:
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{j: $author$project$Page$PageType$Subscribe}),
					$elm$core$Platform$Cmd$none);
			case 7:
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{O: 4, j: $author$project$Page$PageType$Tutos}),
					$elm$core$Platform$Cmd$none);
			case 8:
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{O: 5, j: $author$project$Page$PageType$Images}),
					$elm$core$Platform$Cmd$none);
			case 10:
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{j: $author$project$Page$PageType$SignIn}),
					$elm$core$Platform$Cmd$none);
			case 12:
				var result = msg.a;
				if (!result.$) {
					var userInfos = result.a;
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								O: 3,
								ax: 1,
								j: $author$project$Page$PageType$Home,
								W: $author$project$User$Set(userInfos)
							}),
						$elm$core$Platform$Cmd$none);
				} else {
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{j: $author$project$Page$PageType$SignIn, W: $author$project$User$Failure}),
						$elm$core$Platform$Cmd$none);
				}
			case 11:
				return _Utils_Tuple2(
					model,
					$author$project$Request$authenticateUser(model.J));
			case 5:
				var username = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							J: A2($author$project$Page$SignIn$newUserName, username, model.J)
						}),
					$elm$core$Platform$Cmd$none);
			case 6:
				var pwd = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							J: A2($author$project$Page$SignIn$newFormPwd, pwd, model.J)
						}),
					$elm$core$Platform$Cmd$none);
			case 13:
				var fname = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							p: A2($author$project$Page$SubscribeForm$newFormFName, fname, model.p)
						}),
					$elm$core$Platform$Cmd$none);
			case 14:
				var lname = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							p: A2($author$project$Page$SubscribeForm$newFormLName, lname, model.p)
						}),
					$elm$core$Platform$Cmd$none);
			case 15:
				var _class = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							p: A2($author$project$Page$SubscribeForm$newFormClass, _class, model.p)
						}),
					$elm$core$Platform$Cmd$none);
			default:
				var mail = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							p: A2($author$project$Page$SubscribeForm$newFormMail, mail, model.p)
						}),
					$elm$core$Platform$Cmd$none);
		}
	});
...
var $author$project$Message$SignUp = {$: 4};
var $author$project$Message$ToPictures = {$: 8};
var $author$project$Message$ToTutos = {$: 7};
var $author$project$Message$What = {$: 1};
var $author$project$Message$WhatToDo = {$: 3};
var $author$project$Message$When = {$: 2};
...
var $author$project$Message$Authentication = {$: 10};
var $author$project$Message$BackHome = {$: 9};
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											$elm$html$Html$text(
											$elm$core$String$toUpper(userinfos.dE))
										])),
									A2(
									$elm$html$Html$img,
									_List_fromArray(
										[
											$elm$html$Html$Attributes$src('https://api.adorable.io/avatars/50/' + (userinfos.cz + '.png')),
...
var $author$project$Main$viewHeader = function (model) {
	...
	if (!_v0) {
		return A2(
			...
			_List_Nil,
			A2($author$project$Header$viewElemntsHeader, 0, model.W));
	} else {
		return A2(
			$elm$html$Html$header,
			_List_Nil,
			A2($author$project$Header$viewElemntsHeader, 1, model.W));
	}
};
...
var $author$project$Helpers$Helpers$createBlocks = function (announces) {
	return _List_fromArray(
		[
			A2(
			$elm$html$Html$div,
...
var $author$project$Page$Announce$viewBlocks = function (blocks) {
	switch (blocks) {
		case 0:
		...
		case 1:
			return $author$project$Helpers$Helpers$createBlocks(
				_List_fromArray(
					[
						_Utils_Tuple3('1', 'Un Club', 'd\'une dizaine de personnes'),
						_Utils_Tuple3('2', 'Qui se réunit tous les lundis', 'Entre 12h30 et 13h15'),
						_Utils_Tuple3('3', 'Dans une salle', 'peuplée d\'ordinateurs'),
						_Utils_Tuple3('4', 'Pour apprendre joyeusement ', 'A coder, programmer, créer')
					]));
		case 2:
			return $author$project$Helpers$Helpers$createBlocks(
				_List_fromArray(
		...
		default:
			return $author$project$Helpers$Helpers$createBlocks(
				_List_fromArray(
					[
						_Utils_Tuple3('1', 'La première séance', 'aura lieu le 18 novembre'),
						_Utils_Tuple3('2', 'Et ensuite chaque semaine', 'A la même heure'),
						_Utils_Tuple3('3', 'Tu passeras en priorité', 'au restaurant scolaire'),
						_Utils_Tuple3('4', 'Monte directement en salle 203', 'Dès que possible après la fin du repas')
					]));
	}
};
var $author$project$Message$Class = function (a) {
	return {$: 15, a: a};
};
var $author$project$Message$FirstName = function (a) {
	return {$: 13, a: a};
};
var $author$project$Message$LastName = function (a) {
	return {$: 14, a: a};
};
var $author$project$Message$Mail = function (a) {
	return {$: 16, a: a};
};
...
var $author$project$Page$SubscribeForm$viewForm = function (form) {
	return _List_fromArray(
		[
			...
			_List_fromArray(
				[
					A5($author$project$Page$SubscribeForm$viewInput, 'text', 'Prénom', 'firstname', form.cs, $author$project$Message$FirstName),
					A5($author$project$Page$SubscribeForm$viewInput, 'text', 'Nom', 'lastname', form.cK, $author$project$Message$LastName),
					A5($author$project$Page$SubscribeForm$viewInput, 'text', 'Classe', 'class', form.ce, $author$project$Message$Class),
					A5($author$project$Page$SubscribeForm$viewInput, 'mail', 'Mail', 'mail', form.cM, $author$project$Message$Mail),
					A2(
					$elm$html$Html$input,
					_List_fromArray(
						[
...
var $author$project$Helpers$Helpers$new_logo = A2(
	$elm$html$Html$div,
	_List_fromArray(
		[
	...
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					$elm$html$Html$Attributes$src('./../../assets/pictures/logo/new_logo.png')
				]),
			_List_Nil)
		]));
var $author$project$Page$Landing$viewLogo = _List_fromArray(
	[$author$project$Helpers$Helpers$new_logo]);
...
var $elm$core$Array$appendHelpBuilder = F2(
	function (tail, builder) {
		...
		} : {g: builder.g, c: builder.c, f: appended});
	});
...
var $author$project$Helpers$Helpers$cutLines = F2(
	function (w, result) {
		var lenResult = $elm$core$Array$length(result);
		var _v0 = A2($elm$core$Array$get, lenResult - 1, result);
		if (!_v0.$) {
			var s = _v0.a;
			var lenW = $elm$core$String$length(w);
			var lenS = $elm$core$String$length(s);
			return ((lenS + lenW) > 50) ? A2(
				...
				A2(
					...
					s,
					A2($elm$core$String$append, ' ', w)),
				result);
		} else {
			return result;
		}
	});
var $author$project$Helpers$Helpers$breakNewsLines = function (n) {
	return ($elm$core$String$length(n) <= 40) ? _List_fromArray(
		[n]) : $elm$core$Array$toList(
		A3(
			$elm$core$List$foldl,
			$author$project$Helpers$Helpers$cutLines,
			$elm$core$Array$fromList(
				_List_fromArray(
					[''])),
			A2($elm$core$String$split, ' ', n)));
};
var $author$project$Helpers$Helpers$blockNews = function (announces) {
	return _List_fromArray(
		[
			A2(
			$elm$html$Html$div,
			...
			A2(
				$elm$core$List$map,
				function (n) {
					var lines = $author$project$Helpers$Helpers$breakNewsLines(n);
					return A2(
						$elm$html$Html$section,
						_List_fromArray(
							[
...
var $author$project$Page$Home$news = _List_fromArray(
	['NEWS ', 'Saison 2021-2022', 'Pour apprendre les bases commencez par', 'les tutoriels videos !', 'Happy Coding !']);
var $author$project$Page$Home$viewNews = $author$project$Helpers$Helpers$blockNews($author$project$Page$Home$news);
var $author$project$Message$Profile = {$: 11};
	...
	function (form, user) {
		...
		return _List_fromArray(
			[
				...
				_List_fromArray(
					[
						A4($author$project$Page$SignIn$viewInputText, 'Nom d\'Utilisateur', 'username', form.dE, $author$project$Message$Username),
						A4($author$project$Page$SignIn$viewInputText, 'Mot de passe', 'pwd', form.cY, $author$project$Message$Pwd),
						A2(
						$elm$html$Html$button,
						_List_fromArray(
							[
...
var $tricycle$elm_embed_youtube$Embed$Youtube$Internal$Youtube$YoutubeVideoId = $elm$core$Basics$identity;
var $tricycle$elm_embed_youtube$Embed$Youtube$Internal$Youtube$fromString = function (stringYoutubeVideoid) {
	return A2($tricycle$elm_embed_youtube$Embed$Youtube$Internal$Youtube$Youtube, stringYoutubeVideoid, _List_Nil);
};
...
var $author$project$Page$Tutos$tuto = function (desc) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
							...
							[
								...
								$elm$core$String$concat(
									_List_fromArray(
										[
											'Episode #',
											$elm$core$String$fromInt(desc.cz)
										])))
							])),
						A2(
						$elm$html$Html$h2,
				...
				_List_fromArray(
					[
						$author$project$Page$Tutos$youtube(desc.C)
					]))
			]));
};
var $author$project$Page$Tutos$tutosDescriptions = _List_fromArray(
	[
		...
		cz: 6,
		A: 'Solution du Challenge de Noël',
		C: ''
	},
		{
		v: _List_fromArray(
		...
		cz: 5,
		A: 'Solution du Challenge Puzzle#3',
		C: 'q6lmNj7Y01E'
	},
		{
		v: _List_fromArray(
		...
		cz: 4,
		A: 'Définir des fonctions et faire des puzzles',
		C: 'LjtoQfbhqeM'
	},
		{
		v: _List_fromArray(
...
var $author$project$Page$Tutos$viewTutos = A2(
	...
	A2($elm$core$List$map, $author$project$Page$Tutos$tuto, $author$project$Page$Tutos$tutosDescriptions));
	...
	switch (_v0.$) {
		...
		case 3:
			return A2(
				$elm$html$Html$main_,
				_List_Nil,
				$author$project$Page$SubscribeForm$viewForm(model.p));
		case 4:
			return A2(
				$elm$html$Html$main_,
				_List_fromArray(
				...
				A2($author$project$Page$SignIn$viewSignIn, model.J, model.W));
		case 5:
			return A2(
				$elm$html$Html$main_,
				_List_Nil,
...
var $author$project$Main$main = $elm$browser$Browser$element(
	{
		cD: $author$project$Main$init,
		dj: function (_v0) {
			return $elm$core$Platform$Sub$none;
		},
		dC: $author$project$Main$update,
