	...
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				...
				_Utils_Tuple2(
				'password',
				$elm$json$Json$Encode$string(form.pwd))
			]));
};
	...
	return $elm$http$Http$post(
		{
			...
			expect: A2($elm$http$Http$expectJson, $author$project$Message$GotUserProfile, $author$project$Request$decodeUserProfile),
	...
	function (msg, model) {
		switch (msg.$) {
			...
			case 'What':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							page: $author$project$Page$PageType$Announcement($author$project$Page$Announce$WhatIsIt)
						}),
					$elm$core$Platform$Cmd$none);
			case 'When':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							page: $author$project$Page$PageType$Announcement($author$project$Page$Announce$WhenDoWeStart)
						}),
					$elm$core$Platform$Cmd$none);
			case 'WhatToDo':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							page: $author$project$Page$PageType$Announcement($author$project$Page$Announce$WhatDoWeDo)
						}),
					$elm$core$Platform$Cmd$none);
			case 'SignUp':
				return _Utils_Tuple2(
			...
			case 'Profile':
				return _Utils_Tuple2(
					model,
					$author$project$Request$authenticateUser(model.signinForm));
			case 'Username':
				var username = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
			...
			A2(
				...
				function (n) {
					var lines = A2(
						$elm$core$Debug$log,
						'lines',
						$author$project$Helpers$Helpers$breakNewsLines(n));
					return A2(
						$elm$html$Html$section,
						_List_fromArray(
							[
...
var $author$project$Page$Home$news = _List_fromArray(
	['NEWS ', 'Aujourd\'hui, Challenge de Noel!', 'Allez dans tutos puis images', 'Essayez de coder pour retrouver l\'image originale', 'Bon courage et Joyeuses Fêtes!', 'Un sticker Dr.Racket pour ceux qui finiront le Challenge', 'En montrant leur programme!']);
