...
function _Browser_visibilityInfo()
{
	return (typeof _VirtualDom_doc.hidden !== 'undefined')
		? { au: 'hidden', ar: 'visibilitychange' }
		:
	(typeof _VirtualDom_doc.mozHidden !== 'undefined')
		? { au: 'mozHidden', ar: 'mozvisibilitychange' }
		:
	(typeof _VirtualDom_doc.msHidden !== 'undefined')
		? { au: 'msHidden', ar: 'msvisibilitychange' }
		:
	(typeof _VirtualDom_doc.webkitHidden !== 'undefined')
		? { au: 'webkitHidden', ar: 'webkitvisibilitychange' }
		: { au: 'hidden', ar: 'visibilitychange' };
}
...
var $author$project$Main$Announcement = function (a) {
	return {$: 0, a: a};
};
...
var $author$project$Main$init = function (_v0) {
	var initialModel = {
		g: {G: '', H: '', I: '', J: ''},
		n: $author$project$Main$Announcement(0)
	};
	return _Utils_Tuple2(initialModel, $elm$core$Platform$Cmd$none);
};
var $elm$core$Platform$Sub$batch = _Platform_batch;
var $elm$core$Platform$Sub$none = $elm$core$Platform$Sub$batch(_List_Nil);
var $author$project$Main$Subscribe = {$: 2};
var $author$project$Main$WhatDoWeDo = 2;
var $author$project$Main$WhatIsIt = 1;
var $author$project$Main$WhenDoWeStart = 3;
			...
			case 1:
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							n: $author$project$Main$Announcement(1)
						}),
					$elm$core$Platform$Cmd$none);
			case 2:
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							n: $author$project$Main$Announcement(3)
						}),
					$elm$core$Platform$Cmd$none);
			case 3:
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							n: $author$project$Main$Announcement(2)
						}),
					$elm$core$Platform$Cmd$none);
			case 4:
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{n: $author$project$Main$Subscribe}),
					$elm$core$Platform$Cmd$none);
			case 5:
				var fname = msg.a;
				var currentForm = model.g;
...
var $author$project$Main$SignUp = {$: 4};
var $author$project$Main$What = {$: 1};
var $author$project$Main$WhatToDo = {$: 3};
var $author$project$Main$When = {$: 2};
					...
					[
						...
						_List_fromArray(
							[
								...
								$elm$html$Html$Events$onClick($author$project$Main$What)
							]),
						_List_fromArray(
							[
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('nav'),
								$elm$html$Html$Events$onClick($author$project$Main$WhatToDo)
							]),
						_List_fromArray(
							[
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('nav'),
								$elm$html$Html$Events$onClick($author$project$Main$When)
							]),
						_List_fromArray(
							[
...
var $author$project$Main$Announce = {$: 0};
				...
				[
					...
					_List_fromArray(
						[
							...
							$elm$html$Html$Events$onClick($author$project$Main$Announce)
						]),
					_List_fromArray(
						[
							A2(
...
var $author$project$Main$createBlocks = function (announces) {
	return _List_fromArray(
		[
			A2(
			$elm$html$Html$div,
...
var $author$project$Main$viewBlocks = function (blocks) {
	switch (blocks) {
		case 0:
			return $author$project$Main$createBlocks(
				_List_fromArray(
					[
...
var $author$project$Main$Mail = function (a) {
	return {$: 8, a: a};
};
...
var $author$project$Main$viewForm = function (form) {
	return _List_fromArray(
		[
			A2(
			$elm$html$Html$h1,
			...
			_List_fromArray(
				[
					A5($author$project$Main$viewInput, 'text', 'Prénom', 'firstname', form.H, $author$project$Main$FirstName),
					A5($author$project$Main$viewInput, 'text', 'Nom', 'lastname', form.I, $author$project$Main$LastName),
					A5($author$project$Main$viewInput, 'text', 'Classe', 'class', form.G, $author$project$Main$Class),
					A5($author$project$Main$viewInput, 'mail', 'Mail', 'mail', form.J, $author$project$Main$Mail),
					A2(
					$elm$html$Html$input,
					_List_fromArray(
						[
	...
	switch (_v0.$) {
		case 0:
			...
			return A2(
				$elm$html$Html$main_,
				_List_Nil,
				$author$project$Main$viewBlocks(blocks));
		case 1:
		...
		default:
			return A2(
				$elm$html$Html$main_,
				_List_Nil,
				$author$project$Main$viewForm(model.g));
	}
};
